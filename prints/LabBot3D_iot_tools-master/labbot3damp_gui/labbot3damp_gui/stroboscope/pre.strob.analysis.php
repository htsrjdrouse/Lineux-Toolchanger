...
float bx = <?php echo $_SESSION['labbot3d']['strobdata']['bx']; ?>;
float by = <?php echo $_SESSION['labbot3d']['strobdata']['by']; ?>;
float bs = <?php echo ($_SESSION['labbot3d']['strobdata']['exwidth']); ?>;
...
void setup()
{
  ...
  bx = <?php echo $_SESSION['labbot3d']['strobdata']['bx'];?>;
  by = <?php echo $_SESSION['labbot3d']['strobdata']['by'];?>;
}
...
void draw(){  
  ...
  //Draw deflection line
  stroke(40, 247, 244);
  line(<?=($_SESSION['labbot3d']['strobdata']['deflectxpos']+40) ?>, <?=($_SESSION['labbot3d']['strobdata']['deflectypos']+30) ?>,<?=($_SESSION['labbot3d']['strobdata']['deflectxpos']+40) ?>, <?=($_SESSION['labbot3d']['strobdata']['deflectypos']+30) ?>+1000);
  ...
  noFill();
  //rect(bx, by,200, 300);
  rect(bx, by, <?php echo($_SESSION['labbot3d']['strobdata']['exwidth']); ?> , <?php echo ($_SESSION['labbot3d']['strobdata']['eyheight']); ?>);
  stroke(244, 51, 255);
...
void mousePressed() {
 //Analyze droplets
  if (circleOver) {
    ...
    link("stroboscope/strobsettings.php?set="+bx+","+by+","+<?php echo $_SESSION['labbot3d']['strobdata']['exwidth']; ?>+","+<?php echo $_SESSION['labbot3d']['strobdata']['eyheight']; ?>+"&file="+filen);
  }
 //setSearcharea
  /*
  if (rectOver) {
