...
<? if(isset($_POST['editpcv'])){ 
 ...
 $jsonmicrofl['sensorvalue'] = $_POST['sensval'];
 closejson($jsonmicrofl,'microfluidics.json');
 $jsonmicrofl = json_decode(file_get_contents('microfluidics.json'), true);
 echo "<meta http-equiv='refresh' content='0'>";
}?>
...
<br><br>
<b>Pressure compensation</b><br><br>
...
<? } ?>
<br>
<input type=text name=sensval value=<?=$jsonmicrofl['sensorlevel']?>>
<br>
<input type=submit name=readheatsensor value="Read heat sensor"><br>
