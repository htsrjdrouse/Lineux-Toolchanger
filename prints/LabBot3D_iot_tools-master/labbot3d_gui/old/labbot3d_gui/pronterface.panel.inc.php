...
<p><input type=text name=sendgcode value="<?=$jsonimg['smoothielastcommand']?>" size=15 style="text-align:right;"><input type=submit name=sendgcodecmd value="Send gcode"></p>
