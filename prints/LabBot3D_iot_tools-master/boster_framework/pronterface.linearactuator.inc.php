...
<p><input type=text name=zfeed value="<?=$jsonimg['speed']['zjogfeed']?>" size=15 style="text-align:right;"><input type=submit name=sendzfeed value="Adjust Z speed "></p>
	...
	<input type="range" name="rangeInput" min="200" max="2000" onchange="updateTextInput(this.value);" value=<?=$val?>>
	<br>
	<font size=1><b>Steps: </b></font>
        <input type="text" name="linactsteps" id="ttextInput" value="<?=$steps?>" size="5" style="text-align:right;">
	<input type="range" name="rangeInput" min="1" max="5000" onchange="updateTTextInput(this.value);" value=<?=$steps?>>
	<input type="submit" name="linactsettings" value="Submit settings"><br>
 	<b><font size=1>Move: </font></b><br>
	<p><input type="submit" name="linactmvup" value="Up">
	<input type="submit" name="linactmvdown" value="Down"></p>
