//import("3dify_trident_mods/5015AdapterRister_longer.stl");
//import("3dify_trident_mods/5015AdapterRister_mod_channel.stl");
//import("3dify_trident_mods/5015AdapterRister_mod_fanside.stl");

//color("lightblue")translate([0,170+10-3.6+1.5+6.66,23.6-1.8])rotate([0,0,180])5015AdapterRister_mod_channel();
//color("lightblue")translate([0,170+10-3.6+1.5+6.66,23.6-1.8])rotate([0,0,180])5015AdapterRister_mod_fanside();
carriage_assy();
...
color("grey")translate([0,170+10-3.6+3.4,22])rotate([0,0,180])import("radial_cooling_5015.stl");
...
translate([0,-6+6,22.5-23])import("locking_plate_lineux_one.stl");
//3dify_trident_mods
/*
*/
translate([0,0,0])color("pink")import("carriage_body_rear_trident_v2.stl");
color("peru")import("3dify_trident_mods/5015AdapterRister_longer.stl");
//color("lightblue")translate([0,170+10-3.6+1.5,23.6])rotate([0,0,180])import("5015_adapter_v2.stl"); 
//color("lightblue")translate([0,170+10-3.6+1.5+6.66,23.6-1.8])rotate([0,0,180])import("3dify_trident_mods/5015AdapterRister.stl"); 
//import("3dify_trident_mods/5015AdapterRister_mod_channel.stl");
//import("3dify_trident_mods/5015AdapterRister_mod_fanside.stl");
//color("lightblue")translate([0,170+10-3.6+1.5+6.66,23.6-1.8])rotate([0,0,180])5015AdapterRister_mod_channel();
//color("lightblue")translate([0,170+10-3.6+1.5+6.66,23.6-1.8])rotate([0,0,180])5015AdapterRister_mod_fanside();
//translate([0,200-20+2.95,20-0.445])color("orange")rotate([0,0,180])import("3dify_trident_mods/DuctRister.stl");
...
module 5015AdapterRister_mod_channel(){

difference(){
import("3dify_trident_mods/5015AdapterRister.stl"); 
translate([-10,151,-40])cube([30,40,33]);
}

}

module 5015AdapterRister_mod_fanside(){

difference(){
translate([0,0+3.5,0])import("3dify_trident_mods/5015AdapterRister.stl"); 
//#translate([-10-10,151,-40])cube([50,40,33]);
translate([-10-10,151-40.02-5,-40])cube([50,45,33]);
translate([-10-10+32.75,151-40.02-5+2,-40])cube([50,45,33]);
#translate([-10-10-37,151-40.02-5+2,-40])rotate([0,2.5,0])cube([50,45,33]);
//#translate([-10-11,151-40.02-5+3,-23.25])cube([50,45,33]);
}
...
/*
translate([-2.5-30,100-7.+4-25,-3.6+10-4])cube([70,30,130]);
translate([-2.5-30,100-7.+4-25,-3.6+10-10])#cube([22,30,130]);
translate([-2.5-30+38,100-7.+4-25,-3.6+10-10])#cube([22,30,130]);
*/
